...
app.use(express.static('public')); // publicフォルダにindex.htmlを置くこと

// OpenAI設定（Renderでは環境変数OPENAI_API_KEYにAPIキーをセットしておくこと！）
...
app.post('/tensaku', async (req, res) => {
    try {
        ...
        const completion = await openai.createChatCompletion({
            model: "gpt-4o", // gpt-4oがRenderで使えない場合は "gpt-3.5-turbo" も可
